...
{
    internal static class ImageFileSpecsTestingSharpnessWithRobidoux
    {
        internal static List<ImageFileSpec> ProduceImageFileSpecs()
        {
            return new()
            {
                ...
                new ImageFileSpec(FileSpec.SpecLowRes, FileSpecFormat.Jpeg, 400, 90, 15f, InterpolationFilter.Robidoux, FileSpec.SpecLowRes.ToString()),
                ...
                new ImageFileSpec(FileSpec.SpecLowRes, FileSpecFormat.Jpeg, 400, 90, 25f, InterpolationFilter.Robidoux, FileSpec.SpecLowRes.ToString()),
                new ImageFileSpec(FileSpec.SpecLowRes, FileSpecFormat.Jpeg, 400, 90, 50f, InterpolationFilter.Robidoux, FileSpec.SpecLowRes.ToString()),
                ...
                new ImageFileSpec(FileSpec.Spec2560, FileSpecFormat.Jpeg, 2560, 90, 15f, InterpolationFilter.Robidoux, FileSpec.Spec2560.ToString()),
                ...
                new ImageFileSpec(FileSpec.Spec2560, FileSpecFormat.Jpeg, 2560, 90, 25f, InterpolationFilter.Robidoux, FileSpec.Spec2560.ToString()),
                new ImageFileSpec(FileSpec.Spec2560, FileSpecFormat.Jpeg, 2560, 90, 50f, InterpolationFilter.Robidoux, FileSpec.Spec2560.ToString()),
                ...
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.Jpeg, 3840, 90, 15f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
                ...
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.Jpeg, 3840, 90, 25f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.Jpeg, 3840, 90, 50f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
            };
        }
    }
}
