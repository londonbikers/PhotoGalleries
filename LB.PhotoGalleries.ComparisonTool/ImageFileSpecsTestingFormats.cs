    ...
    internal static class ImageFileSpecsTestingFormats
    {
        internal static List<ImageFileSpec> ProduceImageFileSpecs()
        {
            return new()
            {
                ...
                new ImageFileSpec(FileSpec.Spec800, FileSpecFormat.WebPLossy, 800, 80, 25f, InterpolationFilter.Mitchell, FileSpec.Spec800.ToString()),
                ...
                //new ImageFileSpec(FileSpec.Spec800, FileSpecFormat.WebPLossy, 800, 90, 25f, InterpolationFilter.Mitchell, FileSpec.Spec800.ToString()),
                ...
                //new ImageFileSpec(FileSpec.Spec2560, FileSpecFormat.WebPLossy, 2560, 90, 25f, InterpolationFilter.Mitchell, FileSpec.Spec2560.ToString()),
                ...
                //new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.WebPLossy, 3840, 90, 25f, InterpolationFilter.Mitchell, FileSpec.Spec3840.ToString()),
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.WebPLossy, 3840, 80, 15f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.WebPLossy, 3840, 80, 25f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
                new ImageFileSpec(FileSpec.Spec3840, FileSpecFormat.WebPLossy, 3840, 90, 25f, InterpolationFilter.Robidoux, FileSpec.Spec3840.ToString()),
